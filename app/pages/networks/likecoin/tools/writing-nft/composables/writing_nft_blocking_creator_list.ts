...
export const useWritingNftBlockingCreatorAddressListStore = defineStore("LikecoinWritingNftBlockingCreatorAddressList", {
  state: (() => {
    return {
      address_list: useLocalStorage(
        "LikecoinWritingNftBlockingCreatorAddressList",
        new Set<string>(),
        {
          serializer: {
